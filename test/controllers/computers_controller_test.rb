...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { brand: @computer.brand, code: @computer.code, configure: @computer.configure, date: @computer.date, place: @computer.place, remarks: @computer.remarks, staff_id: @computer.staff_id, state: @computer.state, version: @computer.version } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { brand: @computer.brand, code: @computer.code, configure: @computer.configure, date: @computer.date, place: @computer.place, remarks: @computer.remarks, staff_id: @computer.staff_id, state: @computer.state, version: @computer.version } }
